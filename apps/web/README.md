...
- `NEXT_PUBLIC_API_BASE_URL` (optional client override; defaults to `http://localhost:3001` in development and `https://api.hoptrip.net` in production)
- `API_BASE_URL` (recommended in production for server proxy routes like `/suggestions`; example: `https://api.hoptrip.net`)
